...
import java.awt.event.KeyEvent;
    ...
    public class JFrames extends JFrame {
        ...
        public JFrames() {
            ...
            plusIcon = new ImageIcon("img/plus.png");
            minusIcon = new ImageIcon("img/free_icons/PNG/minus.png");
            multIcon = new ImageIcon("img/famfamfam/icons/disk_multiple.png");
            divIcon = new ImageIcon("img/division.png");
            sqrtIcon = new ImageIcon("img/square-root.jpg");

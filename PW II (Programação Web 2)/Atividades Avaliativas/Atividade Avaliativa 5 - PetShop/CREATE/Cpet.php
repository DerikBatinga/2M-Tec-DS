...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO tb_pet (nome, user_id) VALUES (?, ?)";
...
<body>
    <div class="card p-4 mx-auto" style="max-width: 600px;">
        <h3 class="card-title mb-4">Cadastrar Novo Pet</h3>
        ...
        <form method="POST" action="">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="user_id" class="form-input form-input-small" required>
            </div>
